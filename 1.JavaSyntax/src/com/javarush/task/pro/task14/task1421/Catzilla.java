...
public class Catzilla {
    ...
    private List<Exception> exceptionRockets = List.of(new Exception("Take that!"), new Exception("Catzilla power!"),
            new Exception("You messed with the wrong cat!"), new Exception("You better not get up again!"),
            new Exception("Bang!"), new Exception("Kapaow!"), new Exception("Get some! Get some!"), new Exception("Whatcha gonna do now!?"));
