...
public class Manager {      //singleton
    private static Manager ourInstance = new Manager(); // создаем объект класса Manager
    ...
    public synchronized Table getNextTable() {           // официант ходит по кругу от 1 стола к 10
        Table table = restaurantTables.get(currentIndex);// получаем номер текущего стола
